...
public class ChemicalProcessRegistry
{
    ...
    /**
     * Add a {@link minechemV6Base.process.ChemicalProcessType} with given name to the registry
    ...
    /**
     * Add a {@link minechemV6Base.process.ChemicalProcessComboType} with given name to the registry
     * A child process will be created when the name does not exist in the registry
    ...
    public ChemicalProcessComboType addProcess(ChemicalProcessType... childTypes)
    {
        if (childTypes != null)
        {
            ...
            list.removeAll(Arrays.asList(new ChemicalProcessType[] { null })); // no nulls allowed
            if (list.size() > 1)
            {
    ...
    /**
     * Get the {@link minechemV6Base.process.ChemicalProcessType} for the given process name
    ...
    /**
     * Add a {@link minechemV6Base.process.ChemicalProcess} to an {@link net.minecraft.item.ItemStack}
    ...
    /**
     * Get the output of given {@link net.minecraft.item.ItemStack} using given {@link minechemV6Base.process.ChemicalProcessType}
     * and the given level
